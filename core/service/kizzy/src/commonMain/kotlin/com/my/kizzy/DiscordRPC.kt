...
class DiscordRPC(
    ...
    suspend fun updateSong(
        ...
        setActivity(
            ...
            buttons =
                listOf(
                    "Listen on SimpleMusic" to "https://simpmusic.org/app/watch?v=${song.videoId}",
                    "Visit SimpleMusic" to "https://github.com/Loukious/SimpleMusic",
                ),
            type = Type.LISTENING,
            since = currentTime,
    ...
    companion object {
        ...
        private const val APP_NAME: String = "SimpleMusic"
