 ...
 * This library is from [z-huang/InnerTune] and I just modified it to comply with SimpleMusic
 *
 * Here is the object that can create all request to YouTube Music and Spotify in SimpleMusic
...
class YouTube {
     ...
     * In SimpleMusic, I use this function to parsing Home, Playlist, Album data instead using [album], [playlist], [artist] function
