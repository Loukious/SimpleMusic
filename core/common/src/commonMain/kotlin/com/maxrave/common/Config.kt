...
/**
 * The YouTube stream format ids (`itag`) SimpleMusic asks for, in one place.
 *
...
object MEDIA_NOTIFICATION {
    ...
    const val NOTIFICATION_CHANNEL_NAME = "SimpleMusic Playback Notification"
    const val NOTIFICATION_CHANNEL_ID = "SimpleMusic Playback Notification ID"
}
