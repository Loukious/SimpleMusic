...
/**
 * Thin entry point for SimpleMusic Desktop.
 *
 ...
 */
/**
 * Force the X11 WM_CLASS so the Linux taskbar/dock shows "SimpleMusic" instead of
 ...
 */
private fun forceLinuxWmClass(appName: String = "SimpleMusic") {
