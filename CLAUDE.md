# CLAUDE.md - SimpleMusic Project Guide for AI Agents

## 📋 Project Overview

**SimpleMusic** is a FOSS (Free and Open Source Software) YouTube Music client for Android and Desktop, built with Compose Multiplatform.
...
- **lyricsService/**: Lyrics fetching (LRCLIB, SimpleMusic Lyrics, BetterLyrics)
...
**Location**: `composeApp/src/commonMain/kotlin/com/maxrave/simplemusic/ui/icon/`
...
- **Features**:
  - Deep link support (`simplemusic://` and `simpmusic.org`)
...
**Location**: `core/media/media-jvm/src/main/java/com/simplemusic/media_jvm/mpv/`
...
### Translation
- Use Crowdin: https://crowdin.com/project/simplemusic
...
- **SimpleMusic Chart**: Chart playlists integrated into Library screen
...
- **SimpleMusic Lyrics voting**: Vote functionality for community lyrics
...
- **Deep link support**: `simplemusic://` and `simpmusic.org` URL schemes
...
*This document helps AI Agents quickly understand the SimpleMusic project. Update regularly when there are major changes to architecture or structure.*
